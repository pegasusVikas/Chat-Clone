...
def main():
    ...
    model, tokenizer = FastLanguageModel.from_pretrained(
        ...
        token = HUGGING_FACE_TOKEN ,# use one if using gated models like meta-llama/Llama-2-7b-hf
    )
    ...
    * `q5_k_m` - Recommended. Uses Q6_K for half of the attention.wv and feed_forward.w2 tensors, else Q5_K.
    ...
    if True:
        ...
        model.save_pretrained_gguf("model", tokenizer,max_shard_size="2GB",quantization_method = "f16")
        print("Saved GGUF model")
